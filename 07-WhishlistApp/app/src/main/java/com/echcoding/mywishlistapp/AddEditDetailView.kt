...
fun AddEditDetailView(
    ...
    // Declare independent snackbar state instead of standard scaffoldState
    val snackbarHostState = remember { SnackbarHostState() }
    // Update state is there is an id
    if(id != 0L){
    ...
    Scaffold(
            ...
            )
        {
            ...
            Button(onClick = {
                ...
                scope.launch {
                    // Trigger state modifications via async launch threads
...
fun WishTextField(
    ...
    OutlinedTextField(
        ...
        colors = OutlinedTextFieldDefaults.colors(
            ...
            // Using colors defined in Res.Values.Color
