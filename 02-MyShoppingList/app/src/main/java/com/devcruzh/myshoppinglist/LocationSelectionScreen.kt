...
fun LocationSelectionScreen(
    ...
    // Zoom the area where the user is right now
    ...
    Column(
        ...
        GoogleMap(
            ...
            onMapClick = {
                userLocation.value = it  // Update the user location based on what the use selects on the map
            }
        ) {
        ...
        Button(onClick = {
            ...
            onLocationSelected(newLocation) // Pass the new location to the parent
        }) {
            Text("Set Location")
        }
    }
